  ...
  <fieldset>
    <legend>Please Complete the Details</legend>
     ...
     <div class ="form-group">
       ...
       <div class="form-group">
            <label for="dob" class="col-sm-2 control-label">date_entered:</label>
                       
                        <div class="input-group date">
            <input id="dob" type="text" name="dob" class="form-control" placeholder=" Customer date_entered" ng-model="empInfo.dob"  autofocus required>
        ...
        <select name="class" id = "class" class="form-control">
         <?php
           ...
           $desc=$row->description;
            echo "<option value='$claid'>$claname $desc</option>";
           }
         ?>
      </select>
       </div>
